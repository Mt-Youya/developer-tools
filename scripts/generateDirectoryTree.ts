 ...
 */
const ignores = ["node_modules", ".git", "dist", "build", ".vite-inspect", ".DS_Store"]
export function generateTree(dir: string, prefix = "", ignore = ignores) {
  let result = ""
  ...
  try {
    ...
    console.error(`读取目录出错: ${err?.message || err}`)
  }
