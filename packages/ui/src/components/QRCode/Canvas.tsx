...
import type { QRPropsCanvas } from "./type"
import {
...
export const QRCodeCanvas = forwardRef<HTMLCanvasElement, QRPropsCanvas>(
  (
    {
      value,
      size = DEFAULT_SIZE,
    ...
    }, [bgColor, calculatedImageSettings, cells, fgColor, margin, numCells, size])
