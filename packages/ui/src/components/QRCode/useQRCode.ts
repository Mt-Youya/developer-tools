import { QrCode, QrSegment } from "./QRCode";
import { ERROR_LEVEL_MAP, getImageSettings, getMarginSize } from "./util";
import type { ErrorCorrectionLevel, ImageSettings } from "./type";
