...
function AlertDialogHeader({ className, ...props }: DIV) {
  return (
    <div
...
function AlertDialogFooter({ className, ...props }: DIV) {
  return (
    <div
...
function AlertDialogMedia({ className, ...props }: DIV) {
  return (
    <div
...
type AlertDialogCancelProps = AlertDialogPrimitive.Close.Props & Pick<ButtonProps, "variant" | "size">
