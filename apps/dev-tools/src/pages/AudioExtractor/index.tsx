...
function AudioExtractor() {
  ...
  if (isLoading) return <Loading progress={ffmpegProgress} />

  if (loadError) return <ErrorComp> {loadError} </ErrorComp>

  return (
    <div className="flex-1 bg-linear-to-br from-purple-50 to-blue-50 p-4 md:p-8">
...
function Loading({ progress = 0 }) {
  return (
    <div className="flex-1 bg-linear-to-br from-purple-50 to-blue-50 p-4 md:p-8 flex items-center justify-center">
