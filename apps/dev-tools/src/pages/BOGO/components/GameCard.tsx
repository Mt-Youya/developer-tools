...
import type { FavoritesProps } from ".."

interface Props {
  game: Game
  isFavorite?: boolean
  onToggleFavorite: FavoritesProps["toggleFavoriteGame"]
    ...
    <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-1 p-0 gap-0">
      ...
      <CardContent className="p-4">
        ...
        <Button className="w-full">
          <a href={game.url} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center">
