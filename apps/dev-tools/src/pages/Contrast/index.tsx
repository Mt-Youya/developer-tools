      ...
      <div className="p-4">
        ...
        <Button className="mb-4">
          <Link
            replace
            to="/"
            className="relative pb-1 bg-size-[0_2px] bg-linear-to-r[#92db72_#90ff00] transition-all duration-300 ease-in-out bg-bottom-right bg-no-repeat hover:bg-size-[100%_2px] hover:bg-bottom-left"
          >
            Back Home
          </Link>
        </Button>
        ...
        <Button className="mr-4" onClick={addInput}>
          添加 JSON
        </Button>
        ...
        {jsonObjects.length > 0 && (
          <div className="mt-4">
            <div className="mb-2">
              <Button onClick={() => setMode("table")}>表格模式</Button>
              <Button onClick={() => setMode("tree")}>树形模式</Button>
            </div>
