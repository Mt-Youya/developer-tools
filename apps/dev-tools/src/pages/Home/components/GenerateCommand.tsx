      ...
      <Card className="border-0 shadow-lg bg-gradient-to-r from-green-50 to-emerald-50">
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <CopyComp className="gap-2 bg-green-600 hover:bg-green-700" copyValue={finalCommand} text="复制命令" />
          </div>
        </CardHeader>
          ...
          <Alert className="bg-blue-50 border-blue-200">
            ...
            <AlertDescription className="text-blue-800">
              <ul className="space-y-2 text-sm">
                <li>
                  <strong>基础命令:</strong> <code className="bg-blue-100 px-1 py-0.5 rounded">{baseCommand}</code>
                </li>
                <li>
                  <strong>参数:</strong>{" "}
                ...
                <li>
                  <strong>后缀:</strong> <code className="bg-blue-100 px-1 py-0.5 rounded">{commandSuffix}</code>
                </li>
              </ul>
            </AlertDescription>
          </Alert>
