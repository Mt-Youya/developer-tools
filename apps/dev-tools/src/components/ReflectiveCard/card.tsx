...
function ReflectiveCard({
  ...
  return (
    <div
      className={cn(
        "relative w-[320px] h-[500px] rounded-[20px] overflow-hidden bg-[#1a1a1a] shadow-[0_20px_50px_rgba(0,0,0,0.5),0_0_0_1px_rgba(255,255,255,0.1)_inset] isolate font-sans",
        className
      )}
    ...
    >
      ...
      <video
        ...
        // playsInline
        muted
        className="absolute top-0 left-0 w-full h-full object-cover scale-[1.2] -scale-x-100 z-10 opacity-90 transition-[filter] duration-300"
        style={{
          filter:
      ...
      <div className="absolute inset-0 rounded-[20px] p-px bg-[linear-gradient(135deg,rgba(255,255,255,0.8)_0%,rgba(255,255,255,0.2)_50%,rgba(255,255,255,0.6)_100%)] [mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)] [mask-composite:exclude] z-20 pointer-events-none" />
